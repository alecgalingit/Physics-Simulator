...
(** [is_static obj] if ob is an obj, this returns whether or not it is static, i.e. how it collides with other objects. *)
val make_static : obj -> obj 
(**[make_static obj] takes in an object, whether static or not, and makes it static.*)
